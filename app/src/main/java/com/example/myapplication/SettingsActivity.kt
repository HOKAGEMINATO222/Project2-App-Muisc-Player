...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(MainActivity.themeIndex){
            ...
            4 -> binding.coolRedTheme.setBackgroundColor(Color.YELLOW)
            5 -> binding.coolBlackTheme.setBackgroundColor(Color.YELLOW)
        }
        ...
        binding.coolRedTheme.setOnClickListener { saveTheme(4) }
        binding.coolBlackTheme.setOnClickListener { saveTheme(5) }
